    ...
    return sum % 10 === 0 && sum > 0;
		...
		*/
		...
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			var prompt = $('<div style="display: none;" >');
			...
			//return field.parent().append('<legend class="error">'+promptText+'</legend>').show();
		...
		*/
		 ...
		 _closePrompt: function(field) {
...

			 {
			  ...
			  field.parent().closest("li").find(".fieldset").removeClass("error");
		...
		*/
		...
		_calculatePosition: function (field, promptElmt, options) {var promptTopPosition, promptleftPosition, marginTopSize;
